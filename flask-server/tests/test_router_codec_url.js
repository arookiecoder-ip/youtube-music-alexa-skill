...
const cases = [
  ...
  ['/album/ABC',        '',                       '#album/ABC',              '/album?browse=ABC',            'path-style album deep link'],
  ...
  ['/playlist/PLxxx',   '',                       '#playlist/PLxxx',         '/playlist?list=PLxxx',       'path-style playlist deep link'],
  ...
  ['/artist/UC',        '',                       '#artist/UC',              '/artist?channel=UC',         'path-style artist deep link'],
  ...
  ['/artist/UC/songs',  '',                       '#artist/UC/songs',        '/artist/songs?channel=UC',   'path-style artist songs deep link'],
  ['/artist/songs/UC',  '',                       '#artist/UC/songs',        '/artist/songs?channel=UC',   'prefix-style artist songs deep link'],
